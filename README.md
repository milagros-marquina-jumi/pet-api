...
39 pruebas: unitarias del servicio, de capa web, del cliente con `MockRestServiceServer` y de integración entre capas.
...
- El `petId` `10000023` que aparece en el enunciado puede devolver 404: Petstore reinicia su almacén periódicamente. Crear la mascota con el POST antes de probar el GET.
- Si las llamadas salientes fallan con error de certificado, se debe a la inspección TLS de algunos antivirus. El proyecto delega en el almacén de certificados de Windows para evitarlo.
