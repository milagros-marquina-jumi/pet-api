...
public class PetServiceImpl implements PetService {
    ...
    public CreatePetResponse createPet(CreatePetRequest request) {
        // El identificador se genera al inicio para que acompañe a todos los
        // registros de la operacion: uno emitido al final no aparece en ellos.
        ...
        try {
            ...
            // Los hilos del contenedor se reutilizan entre peticiones: sin esta
            // limpieza el identificador se filtraria a la siguiente.
